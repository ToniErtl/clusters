...
plot(dendextend::color_branches(dendagram, k = 3), main="Hierarchical Clustering with Gower-distance", sub ="Using k = 3 based on scree-plot and silhouette method", leaflab = "none", horiz = F)
...
ggpubr::ggarrange(hc_graph2, kmed_graph2_nocomp, kproto_graph2, kmed_graph2,
