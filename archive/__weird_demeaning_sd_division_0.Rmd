---
title: "SD-vel osztott Demeaned clustering"
author: "Antal Ertl"
date: '2023 03 01 '
...
pca_data_demeaned<- data %>%  mutate(STournamentChoosed =replace_na(STournamentChoosed,0)) %>%
  ...
  mutate(delta_diff = (delta / sd_delta), 
         beta_diff = (beta / sd_beta) ,
         beta_0_diff = (beta_0 / sd_beta_0) ,
         dictator_diff = (dictator / sd_dictator)  ,
         dictator_schoolmate_diff = (dictator_schoolmate / sd_dictator_schoolmate)  ,
         risk_diff = (risk / sd_risk),
         publicgood_diff = (publicgood / sd_publicgood)  ,
         trust_diff = (trust / sd_trust) ,
         trust_return_diff = (trust_return / sd_trust_return)  ,
         ) %>% 
  # mutate(delta_diff = (mean_delta -delta) ,
  #        beta_diff = (mean_beta-beta ),
  #        beta_0_diff = (mean_beta_0-beta_0 ) ,
  #        dictator_diff = (mean_dictator-dictator )   ,
  #        dictator_schoolmate_diff = (mean_dictator_schoolmate -dictator_schoolmate)   ,
  #        risk_diff =  (mean_risk-risk)  ,
  #        publicgood_diff = (mean_publicgood -publicgood) ,
  #        trust_diff = (mean_trust-trust)  ,
  #        trust_return_diff = (mean_trust_return-trust_return) 
  # ) %>% 
  select(studid,classid,delta_diff,beta_diff,beta_0_diff,dictator_diff,dictator_schoolmate_diff,
         risk_diff,publicgood_diff,trust_diff,trust_return_diff)
