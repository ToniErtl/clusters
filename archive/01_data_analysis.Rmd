...
FAMD is essentially a PCA method we can use for both continuous and categorical data (a mix betweeb PCA and MCA)
...
## FAMD version 2 - with less variables
